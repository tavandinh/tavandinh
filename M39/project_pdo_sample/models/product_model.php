...
class ProductModel extends ConnectDatabase
{
    ...
    public function getAllProduct($categoryID = null, $searchProductName = null)
    {
        try {
            ...
            if ($categoryID) {
                $query .= ' AND products.categoryID = :category_id';
            }
            
            // set value for search product_name
            if ($searchProductName) {
                $query .= " AND productName LIKE '%" . $searchProductName . "%'";
            }

            $statement = $this->connection->prepare($query);

            // set value for param categpry_id
            if ($categoryID) {
    ...
    public function getAllProductPagination($limit, $offset, $categoryID = null, $searchProductName = null)
    {
        try {
            $query = 'SELECT * FROM products LEFT JOIN categories ON categories.categoryID = products.categoryID';
