<body>
    ...
    <main>
        <h1>Your Cart</h1>
        <?php if(empty($_SESSION['cart12']) OR count($_SESSION['cart12']) == 0): ?>
        ...
        <?php else: ?>
            <form action="" method="post">
                ...
                <p>Click "Update Cart" to update quantities in your cart. Enter a quantity of 0 to removw an item.</p>
            </form>
        <?php endif; ?>
        <p><a href=".?action=show_add_item">Add Item</a></p>
        <p><a href=".?action=empty_cart">Empty Cart</a></p>
        <p><a href=".?action=delete_session_cookie">End Session and Delete Cookie</a></p>
