<?php
    ...
    // set error ,essage to empty string if no invalid entries
    }else{
        $error_message = '';
    }
...
<body>
    <div id="content">
        ...
        <div id="data">
            ...
            <span><?php echo $years_rate_f;?></span>
            <br>
            ...
            <span>This calculation was done one <?php echo date("d/m/Y");?> .</span>
        </div>
    </div>   
</body>
</html>